        ...
        <div class="modal-body">
          <div class="form-group">
            ...
            <select class="form-control" name="type" required>
              ...
              <option value="fonctionnalite" @selected(old('type') == 'fonctionnalite')>@lang('Requête Fonctionnalité')</option>
            </select>
          </div>
          <div class="form-group">
...
<div class="d-flex flex-wrap justify-content-end gap-2 align-items-center">
    ...
    <a href="https://sicadevd.com/support" target="_blank" class="btn btn-sm btn-outline--primary"><i class="las la-headset"></i> @lang('Request for Support')</a>
</div>
@endpush
