...
@section('content')
    <div id="android-apk-banner" style="display:none; position:fixed; bottom:0; left:0; right:0; z-index:9999; background:#1a7a4a; color:#000; padding:14px 20px; text-align:center; box-shadow:0 -2px 8px rgba(0,0,0,0.3);">
        <span style="font-size:15px; margin-right:12px;color:#000000;">📱 Téléchargez l'application Programme Bandama pour Android</span>
        <a href="{{ url('/assets/Programme_Bandama_base.apk') }}" download="Programme_Bandama_base.apk"
