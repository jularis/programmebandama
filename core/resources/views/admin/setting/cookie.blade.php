                  ...
                  <div class="row">
                    <div class="col-md-3">
                      <div class="form-group">
                        ...
                        <input type="checkbox" data-width="100%" data-height="50" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-on="@lang('Activé')" data-off="@lang('Désactivé')" @if(@$cookie->data_values->status) checked @endif name="status">
                      </div>
                    </div>
                  </div>
                    <div class="form-group">
