                        ...
                        <ul class="list-group">
                            ...
                            <li
                                ...
                                <div class="form-group">
                                    <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success"
                                        ...
                                        data-on="@lang('Activé')" data-off="@lang('Désactivé')" name="en"
                            ...
                            <li
                                ...
                                <div class="form-group">
                                    <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success"
                                        data-offstyle="-danger" data-bs-toggle="toggle" data-height="35"
                                        data-on="@lang('Activé')" data-off="@lang('Désactivé')" name="sn"
                            ...
                            <li
                                ...
                                <div class="form-group">
                                    <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success"
                                        data-offstyle="-danger" data-bs-toggle="toggle" data-height="35"
                                        data-on="@lang('Activé')" data-off="@lang('Désactivé')" name="ln"
