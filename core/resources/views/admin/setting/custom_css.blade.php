...
@endpush
@push('style-lib')
    <link rel="stylesheet" href="{{asset('assets/fcadmin/css/codemirror.min.css')}}">
    <link rel="stylesheet" href="{{asset('assets/fcadmin/css/monokai.min.css')}}">
@endpush
@push('script-lib')
    <script src="{{asset('assets/fcadmin/js/codemirror.min.js')}}"></script>
    <script src="{{asset('assets/fcadmin/js/css.min.js')}}"></script>
    <script src="{{asset('assets/fcadmin/js/sublime.min.js')}}"></script>
@endpush
@push('script')
<script>
    "use strict";
    var editor = CodeMirror.fromTextArea(document.getElementsByClassNom("customCss")[0], {
      lineNumbers: true,
      mode: "text/css",
      theme: "monokai",
      keyMap: "sublime",
