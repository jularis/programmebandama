...
<a href="{{ route('admin.agro.deforestation.index',['download' => 'kml','table'=>request()->table,'section'=>request()->section,'localite'=>request()->localite,'producteur'=>request()->producteur]) }}" class="btn  btn-outline--warning h-45"><i
