...
@section('panel')
    @php
        $selRaisonRefus = $enqueteMenage->raisonsRefus->pluck('valeur')->toArray();
        $selThemes = $enqueteMenage->themes->pluck('valeur')->toArray();
        $selOutils = $enqueteMenage->outils->pluck('valeur')->toArray();
    @endphp
        ...
        <div class="col-lg-12 mb-30">
            <div class="card">
                <div class="card-body">
                    ...
                    <input type="hidden" name="id" value="{{ $enqueteMenage->id }}">
                    <input type="hidden" name="etatSoumission" id="etatSoumission" value="{{ $enqueteMenage->etatSoumission }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            {!! Form::text('raisonInterview', $enqueteMenage->raisonInterview ?? 'Enquête initiale', ['class' => 'form-control', 'readonly']) !!}
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-4 control-label">@lang("Type d'enquête")</label>
                        <div class="col-xs-12 col-sm-8">
                            {!! Form::text('typeEnquete', $enqueteMenage->typeEnquete ?? 'Menage', ['class' => 'form-control', 'readonly']) !!}
                        </div>
                    </div>
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <select class="form-control" name="section" id="section" required>
                                ...
                                @foreach ($sections as $section)
                                    <option value="{{ $section->id }}" @selected($enqueteMenage->section_id == $section->id)>{{ $section->libelle }} ({{ $section->region }} - {{ $section->departement }})</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <select class="form-control" name="localite" id="localite" required>
                                ...
                                @foreach ($localites as $localite)
                                    <option value="{{ $localite->id }}" data-chained="{{ $localite->section_id }}" @selected($enqueteMenage->localite_id == $localite->id)>{{ $localite->nom }} @if($localite->sousprefecture) ({{ $localite->sousprefecture }}) @endif</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <select class="form-control" name="producteur" id="producteur" required>
                                ...
                                @foreach ($producteurs as $producteur)
                                    <option value="{{ $producteur->id }}" data-chained="{{ $producteur->localite_id }}" data-sexe="{{ $producteur->sexe }}" data-code="{{ $producteur->codeProdapp }}" @selected($enqueteMenage->producteur_id == $producteur->id)>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <input type="text" class="form-control" id="sexeProducteurDisplay" value="{{ $enqueteMenage->sexeProducteur }}" disabled>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-4 control-label">@lang('Code du/de la producteur/rice')</label>
                        <div class="col-xs-12 col-sm-8">
                            <input type="text" class="form-control" id="codeProducteurDisplay" value="{{ $enqueteMenage->codeProducteur }}" disabled>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            {!! Form::date('dateEnquete', $enqueteMenage->dateEnquete, ['class' => 'form-control', 'readonly']) !!}
                            <small class="form-text text-muted">La date enregistrée ne peut pas être modifiée.</small>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-4 control-label">@lang("Nom et Prénom(s) de l'enquêteur/trice")</label>
                        <div class="col-xs-12 col-sm-8">
                            {!! Form::text('nomEnqueteur', $enqueteMenage->nomEnqueteur, ['class' => 'form-control', 'required']) !!}
                        </div>
                    </div>
                    {!! Form::hidden('nombreEnfantsEnquetes', $enqueteMenage->nombreEnfants5a17 ?? 0, ['id' => 'nombreEnfantsEnquetes']) !!}

                    <div class="form-group row">
                        <label class="col-sm-4 control-label">@lang('Latitude')</label>
                        <div class="col-xs-12 col-sm-8">
                            {!! Form::text('latitude', $enqueteMenage->latitude, ['class' => 'form-control', 'required']) !!}
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-4 control-label">@lang('Longitude')</label>
                        <div class="col-xs-12 col-sm-8">
                            {!! Form::text('longitude', $enqueteMenage->longitude, ['class' => 'form-control', 'required']) !!}
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <input type="hidden" name="altitude" value="{{ $enqueteMenage->altitude }}">
                    <input type="hidden" name="precisionGps" value="{{ $enqueteMenage->precisionGps }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            {!! Form::select('estProducteurRepondant', ['Oui' => 'Oui', 'Non' => 'Non'], $enqueteMenage->estProducteurRepondant, ['class' => 'form-control', 'id' => 'estProducteurRepondant', 'required']) !!}
                        </div>
                    </div>
                    <div id="blocRepondant">
                        <div class="form-group row">
                            ...
                            <div class="col-xs-12 col-sm-8">
                                {!! Form::text('nomRepondant', $enqueteMenage->nomRepondant, ['class' => 'form-control', 'id' => 'nomRepondant']) !!}
                            </div>
                        </div>
                        <div class="form-group row" id="titreRepondantGroup">
                            ...
                            <div class="col-xs-12 col-sm-8">
                                {!! Form::select('titreRepondant', array_combine($titresRepondant, $titresRepondant), $enqueteMenage->titreRepondant, ['placeholder' => 'Selectionner une option', 'class' => 'form-control', 'id' => 'titreRepondant']) !!}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            {!! Form::select('producteurDisponible', ['Oui' => 'Oui', 'Non' => 'Non'], $enqueteMenage->producteurDisponible, ['class' => 'form-control', 'id' => 'producteurDisponible', 'required']) !!}
                        </div>
                    </div>
                    ...
                    <div id="blocIndisponible">
                        <div class="form-group row">
                            ...
                            <div class="col-xs-12 col-sm-8">
                                {!! Form::select('raisonIndisponibilite', array_combine($raisonsIndisponibilite, $raisonsIndisponibilite), $enqueteMenage->raisonIndisponibilite, ['placeholder' => 'Selectionner une option', 'class' => 'form-control', 'id' => 'raisonIndisponibilite', 'required']) !!}
                            </div>
                        </div>
                        <div id="blocReplanification" class="form-group row">
                            ...
                            <div class="col-xs-12 col-sm-8">
                                {!! Form::date('datePlanification', $enqueteMenage->datePlanification, ['class' => 'form-control', 'required']) !!}
                            </div>
                        </div>
                        <div id="blocRefus">
                            <div class="form-group row">
                                ...
                                <div class="col-xs-12 col-sm-8">
                                    <select class="form-control select2-multi-select" name="raisonRefus[]" id="raisonRefus" multiple="multiple" required>
                                        @foreach ($raisonsRefus as $raison)
                                            <option value="{{ $raison }}" @selected(in_array($raison, $selRaisonRefus))>{{ $raison }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row" id="blocAutreRaisonRefus">
                                ...
                                <div class="col-xs-12 col-sm-8">
                                    {!! Form::text('autreRaisonRefus', $enqueteMenage->autreRaisonRefus, ['class' => 'form-control', 'required']) !!}
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="blocConsentement" class="form-group row">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            {!! Form::select('consentement', ['Oui' => 'Oui', 'Non' => 'Non'], $enqueteMenage->consentement, ['class' => 'form-control', 'id' => 'consentement', 'required']) !!}
                        </div>
                    </div>
                    ...
                    <div id="suiteFormulaire">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xs-12 col-sm-8">
                                {!! Form::select('situationMatrimoniale', array_combine($situationsMatrimoniales, $situationsMatrimoniales), $enqueteMenage->situationMatrimoniale, ['placeholder' => 'Selectionner une option', 'class' => 'form-control', 'required']) !!}
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-xs-12 col-sm-8">
                                {!! Form::number('nombreAdultes', $enqueteMenage->nombreAdultes, ['class' => 'form-control effectifMenage', 'required']) !!}
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-4 control-label">@lang("Nombre d'enfant(s) de 0 à 4 ans dans le ménage/la plantation")</label>
                            <div class="col-xs-12 col-sm-8">
                                {!! Form::number('nombreEnfants0a4', $enqueteMenage->nombreEnfants0a4, ['class' => 'form-control effectifMenage', 'required']) !!}
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-4 control-label">@lang("Nombre d'enfant(s) 5 à 17 ans dans le ménage/la plantation")</label>
                            <div class="col-xs-12 col-sm-8">
                                {!! Form::number('nombreEnfants5a17', $enqueteMenage->nombreEnfants5a17, ['class' => 'form-control effectifMenage', 'required']) !!}
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-xs-12 col-sm-8">
                                <input type="text" class="form-control" id="totalPersonnesMenage" disabled value="{{ $enqueteMenage->totalPersonnesMenage }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xs-12 col-sm-8">
                                {!! Form::select('aEnfantACharge', ['Oui' => 'Oui', 'Non' => 'Non'], $enqueteMenage->aEnfantACharge, ['class' => 'form-control', 'id' => 'aEnfantACharge', 'required']) !!}
                            </div>
                        </div>
                        ...
                        <div id="blocEnfants">
                            <div class="form-group row">
                                ...
                                <div class="col-xs-12 col-sm-8">
                                    {!! Form::number('nombreEnfantsACharge', $enqueteMenage->nombreEnfantsACharge, ['class' => 'form-control', 'required']) !!}
                                </div>
                            </div>

                            <div id="enfants-container">
                                @foreach ($enqueteMenage->enfants as $i => $enfant)
                                    @include('manager.enquetemenage._enfant_fields', ['index' => $i, 'num' => $i + 1, 'enfant' => $enfant])
                                @endforeach
                            </div>
                        ...
                        <div id="blocSensibilisation">
                            ...
                            <div class="form-group row" id="blocAutreThemeSensibilisation">
                                ...
                                <div class="col-xs-12 col-sm-8">
                                    {!! Form::text('autreThemeSensibilisation', $enqueteMenage->autreThemeSensibilisation, ['class' => 'form-control', 'required']) !!}
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-12 col-sm-8">
                                    {!! Form::number('nombreHommesSensibilises', $enqueteMenage->nombreHommesSensibilises, ['class' => 'form-control effectifSensibilisation', 'required']) !!}
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-4 control-label">@lang("Nombre d'adulte(s) femmes sensibilisée(s)")</label>
                                <div class="col-xs-12 col-sm-8">
                                    {!! Form::number('nombreFemmesSensibilisees', $enqueteMenage->nombreFemmesSensibilisees, ['class' => 'form-control effectifSensibilisation', 'required']) !!}
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-4 control-label">@lang("Nombre d'enfant(s) garçons sensibilisé(s)")</label>
                                <div class="col-xs-12 col-sm-8">
                                    {!! Form::number('nombreGarconsSensibilises', $enqueteMenage->nombreGarconsSensibilises, ['class' => 'form-control effectifSensibilisation', 'required']) !!}
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-4 control-label">@lang("Nombre d'enfant(s) filles sensibilisée(s)")</label>
                                <div class="col-xs-12 col-sm-8">
                                    {!! Form::number('nombreFillesSensibilisees', $enqueteMenage->nombreFillesSensibilisees, ['class' => 'form-control effectifSensibilisation', 'required']) !!}
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-4 control-label">@lang('Total personnes sensibilisée(s)')</label>
                                <div class="col-xs-12 col-sm-8">
                                    <input type="text" class="form-control" id="totalPersonnesSensibilisees" disabled value="{{ $enqueteMenage->totalPersonnesSensibilisees }}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-4 control-label">@lang("Numéro de téléphone du/de la producteur/rice ou d'un proche")</label>
                                <div class="col-xs-12 col-sm-8">
                                    {!! Form::text('telephoneProducteurSensibilisation', $enqueteMenage->telephoneProducteurSensibilisation, ['class' => 'form-control', 'required']) !!}
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-4 control-label">@lang('Veuillez prendre/télécharger photo de sensibilisation')</label>
                                <div class="col-xs-12 col-sm-8">
                                    <input type="file" name="photoSensibilisation" accept="image/*" class="form-control dropify-fr" data-default-file="{{ $enqueteMenage->photoSensibilisation ? asset(str_replace('public/', 'storage/', $enqueteMenage->photoSensibilisation)) : '' }}">
                                </div>
                            </div>
                        </div>
                    </div>
...
@push('script')
    <script type="text/javascript">
        $(document).ready(function() {
            var enfantIndex = {{ $enqueteMenage->enfants->count() }};
            ...
            $('#producteurDisponible').on('change', function() {
                if ($(this).val() != 'Non') {
                    $('#raisonIndisponibilite').val('').prop('disabled', true).removeAttr('required');
                } else {
            ...
            toggle($('#blocReplanification'), $('#raisonIndisponibilite').val() == 'Temporairement absent');
            toggle($('#blocRefus'), $('#raisonIndisponibilite').val() == 'Refus');

            $('#raisonRefus').on('change', function() {
                toggle($('#blocAutreRaisonRefus'), selectedTextes($(this)).includes('Autre raison'));
            });
            toggle($('#blocAutreRaisonRefus'), selectedTextes($('#raisonRefus')).includes('Autre raison'));
            ...
            $('#enfants-container .lienParente').each(function() {
                toggle($(this).closest('.enfant-block').find('.autreLienParenteWrap'), $(this).val() == 'Autre');
            });
            ...
            $('#enfants-container .raisonNeVitPasParents').each(function() {
                toggle($(this).closest('.enfant-block').find('.autreRaisonNeVitPasParentsWrap'), $(this).val() == 'Autres');
            });
            ...
            $('#enfants-container .situationScolaire').each(function() {
                var val = $(this).val();
                var $block = $(this).closest('.enfant-block');
                toggle($block.find('.niveauScolaireWrap'), val == 'Scolarisé' || val == 'Déscolarisé');
                toggle($block.find('.raisonNonScolarisationWrap'), val == 'Déscolarisé' || val == 'Jamais scolarisé');
            ...
            $('#enfants-container .raisonNonScolarisation').each(function() {
                toggle($(this).closest('.enfant-block').find('.autreRaisonNonScolarisationWrap'), selectedTextes($(this)).includes('Autre'));
            });
            ...
            $('#enfants-container .extraitNaissance').each(function() {
                toggle($(this).closest('.enfant-block').find('.raisonPasExtraitWrap'), $(this).val() == 'Non');
            });
            ...
            $('#enfants-container .presentDisponible').each(function() {
                var $block = $(this).closest('.enfant-block');
                toggle($block.find('.raisonAbsentWrap'), $(this).val() !== '1');
            });
            ...
            $('#enfants-container .situationsPfte').each(function() {
                var textes = selectedTextes($(this));
                var actif = textes.length > 0 && !(textes.length == 1 && textes[0] == 'Aucune');
                toggle($(this).closest('.enfant-block').find('.raisonTravailAbusWrap'), actif);
            });
            ...
            $('#enfants-container .raisonTravailAbus').each(function() {
                toggle($(this).closest('.enfant-block').find('.autreRaisonTravailAbusWrap'), selectedTextes($(this)).includes('Autre'));
            });

            function majAutreMesure($block) {
                var toutesLesTextes = [];
            ...
            $('#enfants-container').on('change', '.mesures', function() { majAutreMesure($(this).closest('.enfant-block')); });
            $('#enfants-container .enfant-block').each(function() { majAutreMesure($(this)); });

            $('#themesSensibilisation').on('change', function() {
                toggle($('#blocAutreThemeSensibilisation'), selectedTextes($(this)).includes('Autres thèmes'));
            });
            toggle($('#blocAutreThemeSensibilisation'), selectedTextes($('#themesSensibilisation')).includes('Autres thèmes'));
