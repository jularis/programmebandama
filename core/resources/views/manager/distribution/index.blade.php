...
@push('breadcrumb-plugins')
    ...
    <a href="{{ route('manager.agro.distribution.exportExcel.distributionAll') }}" class="btn  btn-outline--warning h-45"><i class="las la-cloud-download-alt"></i> @lang('Exporter en Excel')</a>
@endpush
@push('style')
    <style>
        .table-responsive {
