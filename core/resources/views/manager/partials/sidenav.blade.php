    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                @endif
                @if (Auth::user()->can('manager.suivi.ssrteclmrs.index') || Auth::user()->can('manager.suivi.menage.index') || Auth::user()->can('manager.suivi.enfanttravailleur.index') || Auth::user()->can('manager.suivi.visiteplantation.index'))
                    <li class="sidebar-menu-item sidebar-dropdown">
                        <a href="javascript:void(0)"
                            class="{{ menuActive(['manager.suivi.menage.*', 'manager.suivi.ssrteclmrs.*', 'manager.suivi.enfanttravailleur.*', 'manager.suivi.visiteplantation.*'], 3) }}">
                            <i class=" menu-icon las la-universal-access"></i>
                            <span class="menu-title">@lang('SSRTE') </span>
                        </a>
                        <div class="sidebar-submenu {{ menuActive(['manager.suivi.menage.*', 'manager.suivi.enfanttravailleur.*', 'manager.suivi.visiteplantation.*'], 2) }} ">
                            <ul>
                                ...
                                @endcan
                                @can('manager.suivi.visiteplantation.index')
                                    <li class="sidebar-menu-item {{ menuActive('manager.suivi.visiteplantation.index') }}">
                                        <a href="{{ route('manager.suivi.visiteplantation.index') }}" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                            <span class="menu-title">@lang('Visite Plantation')</span>
                                        </a>
                                    </li>
                                @endcan
                            </ul>
