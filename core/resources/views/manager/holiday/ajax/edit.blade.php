        ...
        <x-form id="save-holiday-data-form" method="PUT">
            <div class="add-client bg-white rounded">
                ...
                <div class="row p-20">
                    ...
                    <div class="col-lg-6">
                        <x-forms.text :fieldLabel="__('app.date')" fieldName="date" fieldId="date"
                            ...
                            :fieldValue="$holiday->date->translatedFormat('Y-m-d')" />
                    </div>
                ...
                <x-form-actions>
                    ...
                    <x-forms.button-cancel :link="route('manager.holidays.index')" class="border-0">@lang('app.cancel')
...
<script>
    $(document).ready(function() {
        ...
        $('#save-holiday-form').click(function() {
            ...
            const url = "{{ route('manager.holidays.update', $holiday->id) }}";
