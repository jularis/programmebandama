    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card bg-white border-0 b-shadow-4">
                         ...
                         <div class="col-lg-2 col-2 dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right border-grey rounded b-shadow-4 p-0"
                                        aria-labelledby="dropdownMenuLink" tabindex="0">
                                            ...
                                            href="{{ route('manager.holidays.edit', $holiday->id) }}">@lang('app.edit')</a>
                ...
                <div class="card-body">
                    <x-cards.data-row :label="__('app.date')" :value="$holiday->date->translatedFormat('Y-m-d')" html="true" />
    ...
    $('body').on('click', '.delete-holiday', function() {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                var url = "{{ route('manager.holidays.destroy', $holiday->id) }}";
