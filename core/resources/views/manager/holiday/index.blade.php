    ...
    <div class="content-wrapper">
        ...
        <div class="d-grid d-lg-flex d-md-flex action-bar">
            <div id="table-actions" class="flex-grow-1 align-items-center">
                    ...
                    <x-forms.link-primary :link="route('manager.holidays.create')" class="mr-3 openRightModal float-left mb-1 mb-lg-0 mb-md-0"
                        icon="plus">
            ...
            <div class="btn-group mt-2 mt-lg-0 mt-md-0 ml-0 ml-lg-3 ml-md-3" role="group" aria-label="Basic example">
                <a href="{{ route('manager.holidays.index') }}" class="btn btn-secondary f-14" data-toggle="tooltip"
                    data-original-title="@lang('app.menu.calendar')"><i class="side-icon bi bi-calendar"></i></a>

                <a href="{{ route('manager.holidays.table_view') }}" class="btn btn-secondary f-14 btn-active" data-toggle="tooltip"
    ...
    <script>
        ...
        $('body').on('click', '.delete-table-row', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var url = "{{ route('manager.holidays.destroy', ':id') }}";
        ...
        const applyQuickAction = () => {
            ...
            var url = "{{ route('manager.holidays.apply_quick_action') }}?row_ids=" + rowdIds;
