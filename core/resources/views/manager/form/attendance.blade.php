...
<div class="d-grid d-lg-flex d-md-flex action-bar">
    <div id="table-actions" class="flex-grow-1 align-items-center">
            ...
            <x-forms.link-primary :link="route('manager.hr.leaves.attendance.create')" class="mr-3 openRightModal float-left"
                                  icon="plus">
        ...
        <x-forms.button-secondary id="export-all" class="mr-3 mb-2 mb-lg-0" icon="file-export">
            ...
            <x-forms.link-secondary :link="route('manager.hr.leaves.attendance.import')" class="mr-3 openRightModal float-left d-none d-lg-block"
                                    icon="file-upload">
                Import
    ...
    <div class="btn-group mt-2 mt-lg-0 mt-md-0 ml-0 ml-lg-3 ml-md-3" role="group">
        <a href="{{ route('manager.hr.leaves.attendance.page') }}" class="btn btn-secondary f-14 btn-active"
           data-toggle="tooltip"
           data-original-title="Resume"><i class="side-icon fa fa-list-ul"></i></a>

        <a href="{{ route('manager.hr.leaves.attendance.page') }}" class="btn btn-secondary f-14" data-toggle="tooltip"
           data-original-title="Presence par Employe"><i
                class="side-icon fa fa-user"></i></a>

        <a href="{{ route('manager.hr.leaves.attendance.page') }}" class="btn btn-secondary f-14" data-toggle="tooltip"
           data-original-title="Presence par Heure"><i class="fa fa-clock"></i></a>

        @if(attendance_setting()->save_current_location)
            <a href="{{ route('manager.hr.leaves.attendance.page') }}" class="btn btn-secondary f-14"
               data-toggle="tooltip" data-original-title="Presence par Lieu"><i
    ...
    <div class="row">
       <div class="col-md-12">
        ...
        Demi-Journée &nbsp;|&nbsp; <i class="fa fa-exclamation-circle text-primary"></i> <i
            class="fa fa-arrow-right text-lightest f-11 mx-1"></i>
        Après &nbsp;|&nbsp; <i class="fa fa-times text-lightest"></i> <i
            class="fa fa-arrow-right text-lightest f-11 mx-1"></i>
