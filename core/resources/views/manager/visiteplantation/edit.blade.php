...
@section('panel')
    @php
        $selRaisonRefus = $visitePlantation->raisonsRefus->pluck('valeur')->toArray();
    @endphp
        ...
        <div class="col-lg-12 mb-30">
            <div class="card">
                <div class="card-body">
                    ...
                    <input type="hidden" name="id" value="{{ $visitePlantation->id }}">
                    <input type="hidden" name="etatSoumission" id="etatSoumission" value="{{ $visitePlantation->etatSoumission }}">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <select class="form-control" name="section" id="section" required>
                                ...
                                @foreach ($sections as $section)
                                    <option value="{{ $section->id }}" @selected($visitePlantation->section_id == $section->id)>{{ $section->libelle }} ({{ $section->region }} - {{ $section->departement }})</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <select class="form-control" name="localite" id="localite" required>
                                ...
                                @foreach ($localites as $localite)
                                    <option value="{{ $localite->id }}" data-chained="{{ $localite->section_id }}" @selected($visitePlantation->localite_id == $localite->id)>{{ $localite->nom }} @if($localite->sousprefecture) ({{ $localite->sousprefecture }}) @endif</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <select class="form-control" name="producteur" id="producteur" required>
                                ...
                                @foreach ($producteurs as $producteur)
                                    <option value="{{ $producteur->id }}" data-chained="{{ $producteur->localite_id }}" data-sexe="{{ $producteur->sexe }}" data-code="{{ $producteur->codeProdapp }}" @selected($visitePlantation->producteur_id == $producteur->id)>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <input type="text" class="form-control" id="sexeProducteurDisplay" value="{{ $visitePlantation->sexeProducteur }}" disabled>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-4 control-label">@lang('Code du/de la producteur/rice')</label>
                        <div class="col-xs-12 col-sm-8">
                            <input type="text" class="form-control" id="codeProducteurDisplay" value="{{ $visitePlantation->codeProducteur }}" disabled>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            {!! Form::date('dateEnquete', $visitePlantation->dateEnquete, ['class' => 'form-control', 'readonly']) !!}
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-4 control-label">@lang('Jour de cette visite plantation')</label>
                        <div class="col-xs-12 col-sm-8">
                            {!! Form::select('jourVisite', ['Lundi' => 'Lundi', 'Mardi' => 'Mardi', 'Mercredi' => 'Mercredi', 'Jeudi' => 'Jeudi', 'Vendredi' => 'Vendredi', 'Samedi' => 'Samedi', 'Dimanche' => 'Dimanche'], $visitePlantation->jourVisite, ['class' => 'form-control', 'placeholder' => 'Selectionner une option', 'required']) !!}
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-4 control-label">@lang("Nom et Prénom(s) de l'enquêteur/trice")</label>
                        <div class="col-xs-12 col-sm-8">
                            {!! Form::text('nomEnqueteur', $nomEnqueteurConnecte ?? $visitePlantation->nomEnqueteur, ['class' => 'form-control', 'readonly']) !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            {!! Form::text('latitude', $visitePlantation->latitude, ['class' => 'form-control', 'placeholder' => 'Latitude', 'required']) !!}
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-4 control-label"></label>
                        <div class="col-xs-12 col-sm-8">
                            {!! Form::text('longitude', $visitePlantation->longitude, ['class' => 'form-control', 'placeholder' => 'Longitude', 'required']) !!}
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <input type="hidden" name="altitude" value="{{ $visitePlantation->altitude }}">
                    <input type="hidden" name="precisionGps" value="{{ $visitePlantation->precisionGps }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            {!! Form::select('estProducteurRepondant', ['Oui' => 'Oui', 'Non' => 'Non'], $visitePlantation->estProducteurRepondant, ['class' => 'form-control', 'id' => 'estProducteurRepondant', 'required']) !!}
                        </div>
                    </div>
                    <div id="blocRepondant">
                        <div class="form-group row">
                            ...
                            <div class="col-xs-12 col-sm-8">
                                {!! Form::text('nomRepondant', $visitePlantation->nomRepondant, ['class' => 'form-control js-required-visible', 'id' => 'nomRepondant']) !!}
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-4 control-label">@lang('Quelle est le titre du répondant?')</label>
                            <div class="col-xs-12 col-sm-8">
                                {!! Form::select('titreRepondant', array_combine($titresRepondant, $titresRepondant), $visitePlantation->titreRepondant, ['placeholder' => 'Selectionner une option', 'class' => 'form-control js-required-visible']) !!}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            {!! Form::select('producteurDisponible', ['Oui' => 'Oui', 'Non' => 'Non'], $visitePlantation->producteurDisponible, ['class' => 'form-control', 'id' => 'producteurDisponible', 'required']) !!}
                        </div>
                    </div>
                    ...
                    <div id="blocIndisponible">
                        <div class="form-group row">
                            ...
                            <div class="col-xs-12 col-sm-8">
                                {!! Form::select('raisonIndisponibilite', array_combine($raisonsIndisponibilite, $raisonsIndisponibilite), $visitePlantation->raisonIndisponibilite, ['placeholder' => 'Selectionner une option', 'class' => 'form-control js-required-visible', 'id' => 'raisonIndisponibilite']) !!}
                            </div>
                        </div>
                        <div id="blocReplanification" class="form-group row">
                            ...
                            <div class="col-xs-12 col-sm-8">
                                {!! Form::date('datePlanification', $visitePlantation->datePlanification, ['class' => 'form-control js-required-visible']) !!}
                            </div>
                        </div>
                        <div id="blocRefus">
                            <div class="form-group row">
                            ...
                            <div class="form-group row" id="blocAutreRaisonRefus">
                                ...
                                <div class="col-xs-12 col-sm-8">
                                    {!! Form::text('autreRaisonRefus', $visitePlantation->autreRaisonRefus, ['class' => 'form-control js-required-visible']) !!}
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="blocConsentement" class="form-group row">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            {!! Form::select('consentement', ['Oui' => 'Oui', 'Non' => 'Non'], $visitePlantation->consentement, ['class' => 'form-control js-required-visible', 'id' => 'consentement']) !!}
                        </div>
                    </div>
                    ...
                    <div id="suiteFormulaire">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xs-12 col-sm-8">
                                {!! Form::number('superficiePlantation', $visitePlantation->superficiePlantation, ['class' => 'form-control js-required-visible', 'step' => '0.01', 'required']) !!}
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-xs-12 col-sm-8">
                                {!! Form::number('nombreManoeuvresPermanents', $visitePlantation->nombreManoeuvresPermanents, ['class' => 'form-control js-required-visible', 'required']) !!}
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-4 control-label">@lang('Parmi ces manœuvres permanents, y a-t-il des personnes de moins de 18 ans?')</label>
                            <div class="col-xs-12 col-sm-8">
                                {!! Form::select('manoeuvresPermanentsMoins18', ['Oui' => 'Oui', 'Non' => 'Non'], $visitePlantation->manoeuvresPermanentsMoins18, ['placeholder' => 'Selectionner une option', 'class' => 'form-control js-required-visible', 'required']) !!}
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-4 control-label">@lang('Combien de manœuvres journaliers travaillent souvent dans la plantation?')</label>
                            <div class="col-xs-12 col-sm-8">
                                {!! Form::number('nombreManoeuvresJournaliers', $visitePlantation->nombreManoeuvresJournaliers, ['class' => 'form-control js-required-visible', 'required']) !!}
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-xs-12 col-sm-8">
                                {!! Form::select('manoeuvresJournaliersMoins18', ['Oui' => 'Oui', 'Non' => 'Non'], $visitePlantation->manoeuvresJournaliersMoins18, ['placeholder' => 'Selectionner une option', 'class' => 'form-control js-required-visible', 'required']) !!}
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-4 control-label">@lang("Nombre d'enfant(s) de 0 à 4 ans dans le ménage/la plantation")</label>
                            <div class="col-xs-12 col-sm-8">
                                {!! Form::number('nombreEnfants0a4', $visitePlantation->nombreEnfants0a4, ['class' => 'form-control js-required-visible', 'required']) !!}
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-4 control-label">@lang("Nombre d'enfant(s) 5 à 17 ans dans le ménage/la plantation")</label>
                            <div class="col-xs-12 col-sm-8">
                                {!! Form::number('nombreEnfants5a17', $visitePlantation->nombreEnfants5a17, ['class' => 'form-control js-required-visible', 'required']) !!}
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-xs-12 col-sm-8">
                                {!! Form::number('nombrePersonnesTrouvees', $visitePlantation->nombrePersonnesTrouvees, ['class' => 'form-control js-required-visible', 'required']) !!}
                            </div>
                        </div>
                        ...
                        <div id="enfants-container">
                            @foreach ($visitePlantation->enfants as $i => $enfant)
                                @include('manager.visiteplantation._enfant_fields', ['index' => $i, 'num' => $i + 1, 'enfant' => $enfant])
                            @endforeach
                        </div>
...
@push('script')
    <script type="text/javascript">
        $(document).ready(function() {
            var enfantIndex = {{ $visitePlantation->enfants->count() }};
