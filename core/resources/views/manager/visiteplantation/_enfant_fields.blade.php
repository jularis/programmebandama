...
<div class="fieldset-like enfant-block" data-enfant-index="{{ $index }}">
    ...
    <div class="form-group row">
        ...
        <div class="col-xs-12 col-sm-8">
            <input type="text" name="enfants[{{ $index }}][nom]" class="form-control" value="{{ $enfant->nom ?? '' }}" @if($readonly) disabled @else required @endif>
        </div>
    </div>
    <div class="form-group row">
        <label class="col-sm-4 control-label">@lang("Date de naissance l'enfant (jj-mm-aa)")</label>
        <div class="col-xs-12 col-sm-8">
            <input type="date" name="enfants[{{ $index }}][dateNaissance]" class="form-control" value="{{ $enfant->dateNaissance ?? '' }}" @if($readonly) disabled @else required @endif>
        </div>
    </div>
    <div class="form-group row">
        <label class="col-sm-4 control-label">@lang("Sexe de l'enfant (M/F)")</label>
        <div class="col-xs-12 col-sm-8">
            <select name="enfants[{{ $index }}][sexe]" class="form-control" @if($readonly) disabled @else required @endif>
    ...
    <div class="form-group row">
        ...
        <div class="col-xs-12 col-sm-8">
            <select name="enfants[{{ $index }}][situationScolaire]" class="form-control situationScolaire" @if($readonly) disabled @else required @endif>
                <option value="">@lang('Selectionner une option')</option>
    ...
    <div class="form-group row raisonTravailAbusWrap">
        ...
        <div class="col-xs-12 col-sm-8">
            <select name="enfants[{{ $index }}][raisonTravailAbus][]" class="form-control select2-multi-select raisonTravailAbus" multiple="multiple" @if($readonly) disabled @endif>
    ...
    <div class="form-group row autreRaisonTravailAbusWrap">
        ...
        <div class="col-xs-12 col-sm-8">
            <input type="text" name="enfants[{{ $index }}][autreRaisonTravailAbus]" class="form-control" value="{{ $enfant->autreRaisonTravailAbus ?? '' }}" @if($readonly) disabled @endif>
        </div>
    </div>
    ...
    <div class="form-group row autreMesureWrap">
        ...
        <div class="col-xs-12 col-sm-8">
            <input type="text" name="enfants[{{ $index }}][autreMesure]" class="form-control" value="{{ $enfant->autreMesure ?? '' }}" @if($readonly) disabled @endif>
        </div>
    </div>
</div>
