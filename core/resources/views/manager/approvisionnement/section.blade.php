                            ...
                            <tbody>
                                @forelse($approvisionnements as $approvisionnement)
                                    <tr>
                                        <td>
                                            <span
                                                class="fw-bold">{{ @$approvisionnement->section->cooperative->name }}</span>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <span>
                                                <a href="{{ asset('core/storage/app/' . $approvisionnement->bon_livraison) }}"
                                                    target="_blank">@lang('Bon de livraison')</a>
                                            </span>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('manager.agro.approvisionnement.edit-section', encrypt($approvisionnement->id)) }}"
                                                class="btn btn-sm btn-outline--primary"><i
...
@push('breadcrumb-plugins')
    <a href="{{ route('manager.agro.approvisionnement.create-section', ['id' => request()->id]) }}"
        class="btn  btn-outline--primary h-45 addNewCooperative">
        <i class="las la-plus"></i>@lang('Ajouter nouveau')
    </a>

    <a href="{{ route('manager.agro.approvisionnement.exportExcel.approvisionnementAll') }}"
