                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="form-group col-lg-12">
                                                ...
                                                <select class="form-control" name="sender_magasin" id="sender_magasin"
                                                    onchange="getSender()" required>
                                                    <option value>@lang('Selectionner une option')</option>
                                                    @foreach ($magSections as $magasin)
                                                        <option value="{{ $magasin->id }}" data-id ="{{ $magasin->id }}"
                                            ...
                                            <div class="form-group col-lg-6">
                                                ...
                                                <input type="text" class="form-control" name="sender_name"
                                                    id="sender_name" value="{{ old('sender_name') }}" readonly required>
                                            </div>
                                            <div class=" form-group col-lg-6">
                                                <label>@lang('Contact')</label>
                                                <input type="text" class="form-control"
                                                    value="{{ old('sender_phone') }}" name="sender_phone" id="sender_phone"
                                                    readonly required>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group col-lg-12">
                                                ...
                                                <input type="email" class="form-control" name="sender_email"
                                                    id="sender_email" value="{{ old('sender_email') }}" readonly required>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group col-lg-12">
                                                ...
                                                <input type="text" class="form-control" name="sender_address"
                                                    id="sender_address" value="{{ old('sender_address') }}" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card border--primary mt-3">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-lg-6">
                                                <label>@lang('Selectionner une remorque')</label>
