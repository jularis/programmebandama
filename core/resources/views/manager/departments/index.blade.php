    ...
    <div class="content-wrapper">
        ...
        <div class="d-grid d-lg-flex d-md-flex action-bar">
            <div id="table-actions" class="flex-grow-1 align-items-center">
                    ...
                    <x-forms.link-primary :link="route('manager.departments.create')" class="mr-3 openRightModal float-left"
                                          icon="plus">
            ...
            <div class="btn-group mt-2 mt-lg-0 mt-md-0 ml-0 ml-lg-3 ml-md-3" role="group" aria-label="Basic example">
                <a href="{{ route('manager.departments.index') }}" class="btn btn-secondary f-14 btn-active"
                   data-toggle="tooltip"
                   data-original-title="@lang('modules.leaves.tableView')"><i class="side-icon fa fa-list-ul"></i></a>

                <a href="{{ route('manager.department.hierarchy') }}" class="btn btn-secondary f-14" data-toggle="tooltip"
                   data-original-title="@lang('modules.department.hierarchy')"><i class="fa fa-project-diagram"></i></a>
            </div>
        </div>
...
@push('script')
    ...
    <script>
        ...
        $('body').on('click', '.delete-table-row', function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var url = "{{ route('manager.departments.destroy', ':id') }}";
        ...
        const applyQuickAction = () => {
            ...
            const url = "{{ route('manager.departments.apply_quick_action') }}?row_ids=" + rowdIds;
