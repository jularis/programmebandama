        ...
        <div class="row gy-5 justify-content-between">
                        ...
                        @foreach ($aboutElements as $aboutElement)
                            <div class="about__item">
                                ...
                                <div class="about__item-content">
                                    <h6 class="about__item-content-title">{{ __($aboutElement->data_values->title) }}
                                    </h6>
                                    <p>
            ...
            <div class="col-xl-6 col-xxl-5 align-self-end">
                <div class="about__thumb">
                    <img src="{{ getImage('assets/images/frontend/about/' . @$about->data_values->background_image, '750x735') }}"
                        alt="@lang('about image')" class="w-100">
                </div>
            </div>
        </div>
    </div>
