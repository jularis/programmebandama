            ...
            <div class="container">
                <div class="banner__content">
                    ...
                    <div class="banner__btn__grp">
                        <a href="{{$banner->data_values->first_button_url}}" class="cmn--btn">{{__($banner->data_values->first_button_name)}}</a>
                        <a href="{{$banner->data_values->second_button_url}}" class="cmn--btn">{{__($banner->data_values->second_button_name)}}</a>
                    </div>
                </div>
            </div>
        </div>
