 ...
 * @property int|null $cooperative_address_id
 * @property-read \App\Models\CooperativeAddress|null $address
 * @method static \Illuminate\Database\Eloquent\Builder|Invoice whereCalculateTax($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Invoice whereCooperativeAddressId($value)
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|Invoice whereCooperativeId($value)
...
class Invoice extends BaseModel
{
    ...
    {
        return $this->belongsTo(CooperativeAddress::class, 'cooperative_address_id');
    }
    ...
    public function getInvoiceNumberAttribute($value)
    {
        ...
        if (cooperative()) {
            $invoiceSettings = cooperative()->invoiceSetting;
        }
        else {
            $invoiceSettings = $this->cooperative ? $this->cooperative->invoiceSetting : null;
        }
