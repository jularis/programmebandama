 ...
 * @method static \Illuminate\Database\Eloquent\Builder|Expense whereCooperativeId($value)
...
class Expense extends BaseModel
{
    ...
    protected $with = ['currency', 'cooperative:id'];
    ...
    public function getPurchaseOnAttribute()
    {
        ...
        return $this->purchase_date->format($this->cooperative ? $this->cooperative->date_format : cooperative()->date_format);
