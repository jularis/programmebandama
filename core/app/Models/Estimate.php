 ...
 * @method static \Illuminate\Database\Eloquent\Builder|Estimate whereCooperativeId($value)
...
class Estimate extends BaseModel
{
    ...
    use Notifiable, CustomFieldsTrait, HasCooperative;
    ...
    public function getOriginalEstimateNumberAttribute()
    {
        ...
        $invoiceSettings = (cooperative()) ? cooperative()->invoiceSetting : $this->client->cooperative->invoiceSetting;
