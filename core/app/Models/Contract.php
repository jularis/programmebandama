 ...
 * @method static \Illuminate\Database\Eloquent\Builder|Contract whereCooperativeLogo($value)
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|Contract whereCooperativeId($value)
 ...
 * @property string|null $cooperative_sign
 * @property string|null $sign_date
 * @property-read mixed $cooperative_signature
 * @method static \Illuminate\Database\Eloquent\Builder|Contract whereCooperativeSign($value)
...
class Contract extends BaseModel
{
    ...
    use CustomFieldsTrait, HasFactory, HasCooperative;
    ...
    protected $appends = ['image_url', 'cooperative_signature', 'original_contract_number'];

    const CUSTOM_FIELD_MODEL = 'App\Models\Contract';

    public function getImageUrlAttribute()
    {
        return ($this->cooperative_logo) ? asset_url_local_s3('contract-logo/' . $this->cooperative_logo) : $this->cooperative->logo_url;
    }
    ...
    {
        $invoiceSettings = (cooperative()) ? cooperative()->invoiceSetting : $this->cooperative->invoiceSetting;
        $zero = '';
    ...
    public function getCooperativeSignatureAttribute()
    {
        return asset_url_local_s3('contract/sign/' . $this->cooperative_sign);
    }
