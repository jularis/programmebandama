 ...
 * @property string|null $cooperative_name
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|ClientDetails whereCooperativeName($value)
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|ClientDetails whereCooperativeId($value)
 * @property string|null $cooperative_logo
 * @property int|null $quickbooks_client_id
 * @property-read mixed $image_url
 * @method static \Illuminate\Database\Eloquent\Builder|ClientDetails whereCooperativeLogo($value)
...
class ClientDetails extends BaseModel
{
    ...
    use CustomFieldsTrait, HasCooperative;

    protected $fillable = ['cooperative_name', 'user_id', 'address', 'postal_code', 'state', 'city', 'office', 'cell', 'website', 'note', 'skype', 'facebook', 'twitter', 'linkedin', 'gst_number', 'shipping_address', 'category_id', 'sub_category_id', 'cooperative_logo'];

    protected $default = ['id', 'cooperative_name', 'address', 'website', 'note', 'skype', 'facebook', 'twitter', 'linkedin', 'gst_number', 'name', 'email', 'cooperative_logo'];
    ...
    {
        return ($this->cooperative_logo) ? asset_url_local_s3('client-logo/' . $this->cooperative_logo) : $this->cooperative->logo_url;
    }
